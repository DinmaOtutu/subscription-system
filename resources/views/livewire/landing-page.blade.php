<div class="flex flex-col bg-indigo-900 w-full h-screen" x-data="{
    ...
    <div class="flex container mx-auto items-center h-full">
        <div class="flex flex-col w-1/3 items-start">
            <h1 class="text-white font-bold text-5xl leading-tight mb-4">
                MY NEWS LETTER SUBSCRIPTION
            </h1>

            <p class="text-indigo-200 text-xl mb-10">
                Be the first to receive emails on <span class="font-bold underline">My Tech Courses</span> and project. Would you mind subscribing?
            </p>

            <x-primary-button class="py-3 px-8 bg-red-500 hover:bg-red-600" x-on:click="showSubscribe = true">
                Subscribe
            </x-primary-button>
        </div>
    </div>
    ...
    <x-my-modal class="bg-pink-500" trigger="showSubscribe">
        ...
        <form class="flex flex-col items-center p-24" wire:submit.prevent="subscribe">
            <input class="px-5 py-3 w-80 border border-blue-400" type="email" name="email" placeholder="Email address" wire:model.defer="email">
